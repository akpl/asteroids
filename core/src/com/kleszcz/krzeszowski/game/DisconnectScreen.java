...
public class DisconnectScreen extends MenuScreen implements Screen {
    private GameScreen gameScreen;

    public DisconnectScreen(Asteroids asteroids, GameScreen gameScreen) {
        super(asteroids);
    ...
    public void show() {
        ...
        final Label header = new Label("Serwer zakończył sesje. Rozlaczono.", skin, "header");
        table.add(header).expandX();

        table.row();

        table.row().width(200).height(50).pad(15);
        final TextButton returnMainMenuButton = new TextButton("Wyjście do menu głównego", skin);
